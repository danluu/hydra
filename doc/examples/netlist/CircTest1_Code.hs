---------------------------------------------------------------------------
module CircTest1_Code where

{- This file could (or should) be derived automatically from
...
---------------------------------------------------------------------------
 ...
 circ_complex_tup_inp (a,b) (c,(d,e),f) = xc
...
-- circ_word_inp [a,b,c] = and3 a b c
 ...
 circ_complex_out a b = or2 (and2 a b) (xor2 b a)
